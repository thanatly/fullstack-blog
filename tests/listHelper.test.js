...
describe('favorite blog', () => {
    ...
    test('when list has only one blog, return its title, author and likes', () => {
    ...
    test('of many blogs, the one with most likes', () => {
...
describe('favorite author', () => {
  test('of many blogs, show author with most likes', () => {
  ...
  test('of many blogs, show author with most blogs', () => {
